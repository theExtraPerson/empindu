        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-warm-cream/60 mb-8 max-w-sm font-body text-sm leading-relaxed">
              Empowering Ugandan artisans, preserving cultural heritage, and giving
              customers a more meaningful way to buy.
            </p>
            <div className="space-y-4">
              <a
                href="mailto:shop@empindu.com"
          ...
          <div>
            <h4 className="font-display text-sm tracking-widest mb-6 text-warm-cream">GUIDE</h4>
            <ul className="space-y-4">
