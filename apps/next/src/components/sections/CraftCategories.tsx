...
const basketryImg = "/ebitemere.jpg";
const barkclothImg = "/barkcloth.jpg";
const woodworkImg = "/woodworking.jpg";
const potteryImg = "/pottery.jpg";
const beadworkImg = "/beadwork.jpg";
const textilesImg = "/textiles.jpg";
