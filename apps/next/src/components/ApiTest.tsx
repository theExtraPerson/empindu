...
//       const healthy = await checkApiHealth(session?.accessToken);
...
//     setError(null);
//     try {
//       const data = await getArtisans(undefined, session?.accessToken);
//       setArtisans(data);
//     } catch (err) {
...
//     setError(null);
//     try {
//       const data = await getProducts(undefined, session?.accessToken);
//       setProducts(data);
//     } catch (err) {
//       setError(err instanceof Error ? err.message : 'Failed to fetch');
//     } finally {
